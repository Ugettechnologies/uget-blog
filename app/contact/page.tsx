    ...
    <div style={{ background: "var(--bg)", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, maxWidth: 760, margin: "0 auto", padding: "60px 24px 80px", width: "100%" }}>
        ...
        <p style={{ fontFamily: "var(--serif)", fontSize: 17, color: "var(--muted)", marginBottom: 40, lineHeight: 1.6 }}>
          Have a question, feedback, editorial inquiry, or technical issue? Reach out directly to the EchoGist team using the form below or our direct email channels.
        </p>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 24, marginBottom: 40 }}>
          <div style={{ padding: 24, background: "var(--bg-2)", border: "1px solid var(--border)", borderRadius: 12 }}>
            ...
            <p style={{ fontFamily: "var(--sans)", fontSize: 13, color: "var(--muted)", margin: "0 0 10px" }}>
              For article pitches, corrections, and guest author inquiries:
            </p>
            <a href="mailto:editor@echo-gist.com" style={{ color: "var(--brand)", fontWeight: 600, fontSize: 14, textDecoration: "underline" }}>
              editor@echo-gist.com
            </a>
          </div>
          ...
          <div style={{ padding: 24, background: "var(--bg-2)", border: "1px solid var(--border)", borderRadius: 12 }}>
            ...
            <a href="mailto:support@echo-gist.com" style={{ color: "var(--brand)", fontWeight: 600, fontSize: 14, textDecoration: "underline" }}>
        ...
        <div style={{ padding: 32, background: "var(--bg-2)", border: "1px solid var(--border)", borderRadius: 16 }}>
          ...
          {submitted ? (
            <div style={{ padding: 20, background: "rgba(16, 185, 129, 0.1)", border: "1px solid rgba(16, 185, 129, 0.3)", borderRadius: 8, color: "#10b981" }}>
              ...
              <p style={{ margin: 0, fontSize: 14, color: "var(--ink)" }}>Thank you for reaching out! A member of our editorial team will reply to <strong>{formData.email}</strong> within 24–48 business hours.</p>
            </div>
          ) : (
