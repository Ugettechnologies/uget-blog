    ...
    <div style={{ background: "var(--bg)", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, maxWidth: 680, margin: "0 auto", padding: "60px 24px 80px", width: "100%" }}>
        <h1 style={{ fontFamily: "var(--display)", fontSize: 36, fontWeight: 700, marginBottom: 8, color: "var(--black)" }}>
          The UGET Official Blog
        </h1>
        <p style={{ fontFamily: "var(--sans)", fontSize: 13, color: "var(--muted)", marginBottom: 40 }}>
          Product updates, design notes, and stories from inside UGET.
        </p>

        <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
          {[
            { date: "June 18, 2026", title: "Introducing Self-Healing Database Warnings on Live Dashboard", excerpt: "To assist developers and project owners during deployment, UGET's dashboard now detects missing database schemas automatically and offers a single-click self-healing migration button directly in the UI." },
            ...
            { date: "April 12, 2026", title: "Why We Choose Direct Member Support Over Ad Monetization", excerpt: "Monetization shapes incentives. Learn more about our decision to completely omit display ads from UGET, placing the relationship between writer and reader first." }
          ].map((blogPost) => (
