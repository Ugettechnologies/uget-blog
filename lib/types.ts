...
export const CATEGORIES = [
  ...
  { id: "comic", label: "Comics & Manga", icon: "🦸" },
  ...
  { id: "writing", label: "Writing & Art", icon: "✍️" },
  { id: "marketing", label: "Marketing", icon: "📈" },
  { id: "blockchain", label: "Web3 & Blockchain", icon: "⛓️" },
  { id: "hardware", label: "Hardware & IoT", icon: "🔌" },
  { id: "education", label: "Education", icon: "🎓" },
  { id: "lifestyle", label: "Lifestyle", icon: "🌱" },
  { id: "business", label: "Business & Management", icon: "👔" },
  { id: "history", label: "History & Politics", icon: "📜" },
  ...
  { id: "philosophy", label: "Philosophy & Psychology", icon: "💭" },
