      ...
      <div className="post-card-content">
        ...
        <div className="post-card-meta">
          <div className="post-card-meta-left">
            <span className="post-card-read-time">{post.read_time} min read</span>
            <span className="post-card-read-time-short">{post.read_time}m</span>
            <span>·</span>
            <span className="flex items-center gap-1" title={`${post.view_count || 0} views`}>
              ...
              <span className="post-card-views-label">views</span>
            </span>
          </div>
