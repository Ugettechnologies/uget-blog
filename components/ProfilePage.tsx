...
export default function ProfilePage() {
  ...
  const handleSharePost = async (e: React.MouseEvent, post: Post) => {
    e.preventDefault();
    e.stopPropagation();
          ...
          <div className="uget-profile-feed">
                          ...
                          <div className="post-card-content">
                            ...
                            <div className="post-card-meta" style={{ marginTop: 8 }}>
                              ...
                              <div className="post-card-meta-actions">
                                ...
                                <button
                                  type="button"
                                  onClick={(e) => { e.preventDefault(); e.stopPropagation(); handleToggleLike(post.id); }}
                                ...
                                <button
                                  ...
                                  className="post-card-action-btn"
                                  title={isCopied ? "Link Copied!" : "Share story"}
                                  aria-label="Share story"
                                >
                                  <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5" />
                                  </svg>
                                  {isCopied && <span className="share-copied-toast">Copied!</span>}
                                </button>

                                {/* Bookmark */}
                                <button
                                  type="button"
                                  onClick={(e) => { e.preventDefault(); e.stopPropagation(); handleToggleBookmark(post.id); }}
            ...
            {activeTab === "about" && (
              <div style={{ padding: "8px 0" }}>
                ...
                {/* Social links block in About tab */}
                {(profile.website || profile.twitter) && (
                  <div style={{ marginTop: 32, paddingTop: 24, borderTop: "1px solid var(--border-2)" }}>
                    <h4 style={{ fontFamily: "var(--sans)", fontSize: 12, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: "var(--muted)", marginBottom: 14 }}>
                      Links & Connect
                    </h4>
